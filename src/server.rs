...
impl Auth for AuthImpl {
    async fn register(
        ...
        let user_info = UserInfo {
            ...
            y1: BigUint::from(request.y1 as u64),
            y2: BigUint::from(request.y2 as u64),
            ..Default::default()
        };
    ...
    async fn create_authentication_challenge(
        ...
        if let Some(user_info) = user_info_hashmap.get_mut(&user_name) {
            ...
            user_info.c = c.clone();
            user_info.r1 = BigUint::from(request.r1 as u64);
            user_info.r2 = BigUint::from(request.r2 as u64);
    ...
    async fn verify_authentication(
        ...
        if let Some(user_name) = auth_id_to_user_hashmap.get(&auth_id) {
            ...
            let s = BigUint::from(request.s as u64);
            user_info.s = s;
